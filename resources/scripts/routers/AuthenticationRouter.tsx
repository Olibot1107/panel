...
import FirstAdminSetupContainer from '@/components/auth/FirstAdminSetupContainer';
import AuthAccentPicker from '@/components/auth/AuthAccentPicker';
    ...
    return (
        <AuthLayout>
            ...
            <Switch location={location}>
                ...
                <Route path={`${path}/setup`} component={FirstAdminSetupContainer} exact />
