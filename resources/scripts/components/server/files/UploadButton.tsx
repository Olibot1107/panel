            ...
            return () =>
                getFileUploadUrl(uuid).then((url) =>
                    axios
                        ...
                        .then(() => timeoutsRef.current.push(setTimeout(() => removeFileUpload(file.name), 500)))
                );
        });
                ...
                <Fade appear in={visible} timeout={75} key={'upload_modal_mask'} unmountOnExit>
                    ...
                    >
                        <div className={'w-full flex items-center justify-center pointer-events-none'}>
                            <div
                                className={
                                    'flex items-center space-x-4 bg-black w-full ring-4 ring-orange-200 ring-opacity-60 rounded p-6 mx-10 max-w-sm'
                                }
                            >
