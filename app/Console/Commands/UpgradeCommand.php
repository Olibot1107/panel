...
class UpgradeCommand extends Command
{
    ...
    protected $signature = 'p:upgrade
        ...
        {--release= : A specific Voidium version to download from GitHub. Leave blank to use latest.}
        {--skip-download : If set no archive will be downloaded.}';

    protected $description = 'Downloads a new archive for Voidium from GitHub and then executes the normal upgrade commands.';

    /**
     * Executes an upgrade command which will run through all of our standard
     * commands for Voidium and enable users to basically just download
